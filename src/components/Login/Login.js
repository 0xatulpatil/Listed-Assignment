...
import { auth, googleProvider } from "../../shared/service/firebase";
import {
...
export const Login = () => {
	...
	const signUpWithGoogle = async () => {
		try {
			isLoading(1);
			let user = await signInWithRedirect(auth, googleProvider).user;
			if (user) {
				isLoading(0);
				...
				<div className={styles.centered}>
					...
					<div className={styles.container}>
						...
						<div className={styles.header}>
							<div className={styles.heading}>Sing In</div>
							<div className={styles.subHeading}>Sing into your account</div>
						</div>
						{/* Sing In Options */}
						<div className={styles.buttons}>
							<div className={styles.button}>
								...
								<div className={styles.buttonText} onClick={signUpWithGoogle}>
									{loading === 1 ? (
										<SpinnerCircular
											size={20}
											thickness={200}
						...
						<div className={styles.form}>
							...
							<div className={styles.submitBtn} onClick={signIn}>
								{loading === 2 ? (
									<SpinnerCircular
										size={30}
										thickness={200}
						...
						<div className={styles.footer}>
							...
							<span className={styles.hyperlink}>Register Here</span>
						</div>
					</div>
				</div>
			</div>
